(function () {
  ...
  function renderSkeleton() {
    rootEl.innerHTML =
      ...
      '<p class="sfc-lead">Válassz egy receptet, állítsd be a rendelkezésre álló alapanyag mennyiségét és a kalkulátor arányosan újraszámolja az egész receptet. A lista folyamatosan bővül, ezért érdemes gyakran vissza látogatni a finomságokért.</p>' +
